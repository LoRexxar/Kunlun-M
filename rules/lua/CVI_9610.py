...
class CVI_9610(SingleRuleMixin):
    """
    lua XPath注入规则
    """
    ...
    def __init__(self):
        ...
        self.description = "将用户输入拼接到XPath查询中可能导致XPath注入。建议使用参数化查询。"
        self.level = 8

        # 部分配置
        self.match_mode = "function-param-regex"
        self.match = r"xpath\.parse\s*\(|xpath\.selectNodes\s*\("

        self.vul_function = [
        "xpath.parse", "xpath.selectNodes"
        ]
