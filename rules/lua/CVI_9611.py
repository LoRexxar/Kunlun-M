...
class CVI_9611(SingleRuleMixin):
    """
    lua 不安全反序列化规则
    """
    ...
    def __init__(self):
        ...
        self.description = "使用json.decode或msgpack.unpack反序列化不受信任的数据可能导致安全问题。建议验证和限制反序列化的数据结构。"
        self.level = 8

        # 部分配置
        self.match_mode = "function-param-regex"
        self.match = r"json\.decode\s*\(|cjson\.decode\s*\(|msgpack\.unpack\s*\("
