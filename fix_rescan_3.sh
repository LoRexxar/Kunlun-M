...
PROJECTS="cli/cli|v2.63.2|go
kee-org/KeeWeb|v1.19.0|javascript
marktext/marktext|v0.17.3|typescript
coder/code-server|v4.92.2|typescript
nushell/nushell|0.98.0|rust
shadowsocks/shadowsocks-libev|v3.3.5|c
redis/hiredis|v1.2.0|c
nodejs/undici|v6.19.8|javascript
...
while IFS='|' read -r repo ref lang; do
    ...
    timeout 1800 python3 kunlun.py scan -t "$outdir" --yes -lan "$lang" --no-cache 2>/tmp/fix_r3_${dir_name}.log
    rc=$?
